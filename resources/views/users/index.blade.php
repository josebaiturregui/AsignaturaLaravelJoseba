...
<body>
  <h1 class="text-3xl font-bold mx-[auto] my-[100px] pt-[100px] text-center">
    Biblioteca App
  </h1>
  ...
  <div class= "grid w-384 max-w-384 min-w-384 xxs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 px-4">
      ...
      <div class="max-w-sm rounded overflow-hidden shadow-lg mx-[auto] my-[100px]">
        ...
        <div class="grid px-6 pt-4 pb-2">
          <span class="inline-block bg-blue-200 rounded-[10px] px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Genero : {{ $libro->genero }} </a></span>
        </div>
          ...
          <span class="inline-block bg-gray-200 rounded-[10px] px-3 text-sm font-semibold text-gray-700 mr-2 mb-2 pt-1 cursor-pointer text-center">
            <div class="col-sm">
              <form action="{{ route('entregarLibro', $libro->id) }}" method="post">
                ...
                value="1"
                >
                <button class="inline-block bg-gray-200 rounded-[10px] px-3 text-sm font-semibold text-gray-700 mr-2 mb-2 cursor-pointer text-center"
                type='submit'>
                Entregar Libro</button>
